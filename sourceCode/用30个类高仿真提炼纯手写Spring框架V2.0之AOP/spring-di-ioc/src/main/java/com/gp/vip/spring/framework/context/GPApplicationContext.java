...
import com.gp.vip.spring.framework.aop.GPAopProxy;
import com.gp.vip.spring.framework.aop.GPCglibAopProxy;
import com.gp.vip.spring.framework.aop.GPJdkDynamicAopProxy;
    ...
    private Object instantiateBean(String beanName, GPBeanDefinition gpBeanDefinition) {
        ...
        try {
            ...
            if (this.singletonObjects.containsKey(className)) {
                ...
                config.setTargetClass(Class.forName(className));
                config.setTarget(instance);
                
                //符合PointCut的规则就创建代理对象
