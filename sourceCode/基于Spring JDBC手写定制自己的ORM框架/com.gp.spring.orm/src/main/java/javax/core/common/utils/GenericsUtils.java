...
public class GenericsUtils {
    ...
    /**
     * 通过反射，获取定义Class时声明的父类泛型参数的类型，如public BookManager extends GenricManager<Book>
     * 
     * @param clazz
     * @return
     */
    ...
    public static Class getSuperClassGenricType(Class clazz, int index) {
        ...
        if (!(params[index] instanceof Class)) {
            logger.warn(clazz.getSimpleName() + " not set the actual class on superclass generic paramter");
        }
